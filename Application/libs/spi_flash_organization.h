...
/* IEC104 event log */
#define IEC104_EVTLOG_SECTOR_SIZE           4096U
#define IEC104_EVTLOG_SIZE                  SPIFLASH_SECTION_SIZE(SPIFLASH_SECTION_IEC104_EVTLOG)
#define IEC104_EVTLOG_ADDR                  SPIFLASH_SECTION_ADDR(SPIFLASH_SECTION_IEC104_EVTLOG)
#define IEC104_EVTLOG_SECTOR_COUNT          (IEC104_EVTLOG_SIZE / IEC104_EVTLOG_SECTOR_SIZE)
