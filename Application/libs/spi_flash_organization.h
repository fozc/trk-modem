...
typedef struct
{
    ...
    uint8_t SPIFLASH_SECTION_NVRAM                           [0x002000];  /*    8 KB  0x210000 */
    uint8_t SPIFLASH_SECTION_NVRAM_BACKUP                    [0x002000];  /*    8 KB  0x212000 */
    uint8_t SPIFLASH_SECTION_ELOG_LOG                        [0x002000];  /*    8 KB  0x214000 */
    uint8_t SPIFLASH_SECTION_FAULT_LOG_SUPERBLOCK            [0x001000];  /*    4 KB  0x216000 */
    uint8_t SPIFLASH_SECTION_FAULT_LOG_SUPERBLOCK_BACKUP     [0x001000];  /*    4 KB  0x217000 */
    uint8_t SPIFLASH_SECTION_FAULT_LOG                       [0x008000];  /*   32 KB  0x218000 */
    uint8_t SPIFLASH_SECTION_FAULT_LOG_BACKUP                [0x008000];  /*   32 KB  0x220000 */
    uint8_t SPIFLASH_SECTION_IEC104_EVTLOG_SUPERBLOCK        [0x001000];  /*    4 KB  0x228000 */
    uint8_t SPIFLASH_SECTION_IEC104_EVTLOG_SUPERBLOCK_BACKUP [0x001000];  /*    4 KB  0x229000 */
    uint8_t SPIFLASH_SECTION_IEC104_EVTLOG_DATA              [0x002000];  /*    8 KB  0x22A000 */
    uint8_t SPIFLASH_SECTION_IEC104_EVTLOG_DATA_BACKUP       [0x002000];  /*    8 KB  0x22C000 */
    uint8_t SPIFLASH_SECTION_IEC104_LOG                      [0x002000];  /*    8 KB  0x22E000 */
} spi_flash_layout_t;
...
/* Event log (spi_flash_log append-only ring, 2 sectors) */
#define ELOG_LOG_AREA_SIZE                  SPIFLASH_SECTION_SIZE(SPIFLASH_SECTION_ELOG_LOG)
#define ELOG_LOGAREA_ADDRESS                SPIFLASH_SECTION_ADDR(SPIFLASH_SECTION_ELOG_LOG)
#define ELOG_LOG_SECTOR_COUNT               (ELOG_LOG_AREA_SIZE / 4096UL)
...
/* IEC104 diagnostic log (connection events; iec104_log module) */
#define IEC104_LOG_AREA_SIZE                SPIFLASH_SECTION_SIZE(SPIFLASH_SECTION_IEC104_LOG)
